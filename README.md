...
psql "$DATABASE_URL" -f supabase/seed/10_pack_be.sql    # or 11_pack_fr.sql, 12_pack_lu.sql, 13_pack_ee.sql, 14_pack_gb.sql, 15_pack_us.sql, 16_pack_ie.sql, 19_pack_es.sql, 20_pack_sn.sql, 21_pack_ci.sql
```
