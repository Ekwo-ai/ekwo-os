...
values
  ...
  ('IL', 'default', '1700', 'השקעות בחברות מוחזקות', '{"en":"Investments in related companies"}'::jsonb, 'asset_non_current', false, null, 280),
  ('IL', 'default', '1710', 'פיקדונות והלוואות לזמן ארוך', '{"en":"Long-term deposits and loans receivable"}'::jsonb, 'asset_non_current', false, null, 290),
  ('IL', 'default', '1750', 'נכסים בלתי מוחשיים — עלות', '{"en":"Intangible assets — cost"}'::jsonb, 'asset_non_current', false, null, 300),
  ('IL', 'default', '1751', 'נכסים בלתי מוחשיים — הפחתה נצברת', '{"en":"Intangible assets — accumulated amortisation"}'::jsonb, 'asset_non_current', false, null, 310),
  ('IL', 'default', '2000', 'ספקים', '{"en":"Trade payables"}'::jsonb, 'liability_payable', true, null, 320),
  ('IL', 'default', '2010', 'זכאים שונים והוצאות לשלם', '{"en":"Other payables and accrued expenses"}'::jsonb, 'liability_current', false, null, 330),
  ('IL', 'default', '2020', 'הכנסות מראש', '{"en":"Deferred revenue"}'::jsonb, 'liability_current', false, null, 340),
  ('IL', 'default', '2030', 'מקדמות מלקוחות', '{"en":"Advances from customers"}'::jsonb, 'liability_current', false, null, 350),
  ('IL', 'default', '2050', 'שכר עבודה לשלם', '{"en":"Wages payable"}'::jsonb, 'liability_current', false, null, 360),
  ('IL', 'default', '2060', 'מוסדות — ניכויים לביטוח לאומי ולמס הכנסה', '{"en":"National Insurance and income tax withholdings payable"}'::jsonb, 'liability_current', false, null, 370),
  ('IL', 'default', '2100', 'מע״מ עסקאות', '{"en":"VAT output tax"}'::jsonb, 'liability_current', false, null, 380),
  ('IL', 'default', '2110', 'מע״מ לשלם לרשות המסים — נטו לאחר הגשת דוח', '{"en":"VAT payable to the Tax Authority — net, after a filed return"}'::jsonb, 'liability_current', true, null, 390),
  ('IL', 'default', '2150', 'הפרשה לפיצויי פרישה — חלק שוטף', '{"en":"Severance pay provision — current portion"}'::jsonb, 'liability_current', false, null, 400),
  ('IL', 'default', '2200', 'אשראי בנקאי לזמן קצר ומשיכת יתר', '{"en":"Short-term bank credit and overdraft"}'::jsonb, 'liability_current', false, null, 410),
  ('IL', 'default', '2210', 'חלות שוטפות של הלוואות לזמן ארוך', '{"en":"Current portion of long-term loans"}'::jsonb, 'liability_current', false, null, 420),
  ('IL', 'default', '2300', 'הלוואות לזמן ארוך', '{"en":"Long-term loans"}'::jsonb, 'liability_non_current', false, null, 430),
  ('IL', 'default', '2350', 'הפרשה לפיצויי פרישה — חלק לא שוטף', '{"en":"Severance pay provision — non-current portion"}'::jsonb, 'liability_non_current', false, null, 440),
  ('IL', 'default', '2990', 'חשבון מעבר', '{"en":"Suspense account"}'::jsonb, 'liability_current', false, null, 450),
  ('IL', 'default', '3000', 'הון מניות', '{"en":"Share capital"}'::jsonb, 'equity', false, null, 460),
  ('IL', 'default', '3010', 'פרמיה על מניות', '{"en":"Share premium"}'::jsonb, 'equity', false, null, 470),
  ('IL', 'default', '3020', 'קרנות הון', '{"en":"Capital reserves"}'::jsonb, 'equity', false, null, 480),
  ('IL', 'default', '3200', 'עודפים', '{"en":"Retained earnings"}'::jsonb, 'equity_retained', false, null, 490),
  ('IL', 'default', '3210', 'דיבידנד שהוכרז', '{"en":"Dividends declared"}'::jsonb, 'equity_retained', false, null, 500),
  ('IL', 'default', '4000', 'הכנסות ממכירת טובין בישראל', '{"en":"Sales of goods in Israel"}'::jsonb, 'income', false, null, 510),
  ('IL', 'default', '4010', 'הכנסות ממתן שירותים בישראל', '{"en":"Sales of services in Israel"}'::jsonb, 'income', false, null, 520),
  ('IL', 'default', '4020', 'הכנסות ממכירות ליצוא', '{"en":"Export sales"}'::jsonb, 'income', false, null, 530),
  ('IL', 'default', '4030', 'הכנסות משכירות', '{"en":"Rental income"}'::jsonb, 'income', false, null, 540),
  ('IL', 'default', '4700', 'רווחי שער חליפין — ממומשים', '{"en":"Realised foreign exchange gain"}'::jsonb, 'income_other', false, null, 550),
  ('IL', 'default', '4710', 'רווחי שער חליפין — טרם מומשו', '{"en":"Unrealised foreign exchange gain"}'::jsonb, 'income_other', false, null, 560),
  ('IL', 'default', '4790', 'הכנסות אחרות', '{"en":"Other income"}'::jsonb, 'income_other', false, null, 570),
  ('IL', 'default', '5000', 'עלות המכר — סחורה', '{"en":"Cost of goods sold"}'::jsonb, 'expense_direct_cost', false, null, 580),
  ('IL', 'default', '5010', 'הובלה ושחרור מכס', '{"en":"Freight and customs clearance"}'::jsonb, 'expense_direct_cost', false, null, 590),
  ('IL', 'default', '5020', 'עבודות קבלני משנה', '{"en":"Subcontractor work"}'::jsonb, 'expense_direct_cost', false, null, 600),
  ('IL', 'default', '5030', 'החזרות וזיכויים מספקים', '{"en":"Purchase returns and allowances"}'::jsonb, 'expense_direct_cost', false, null, 610),
  ('IL', 'default', '6100', 'שכר עבודה ונלוות', '{"en":"Salaries and related costs"}'::jsonb, 'expense', false, null, 620),
  ('IL', 'default', '6110', 'הפרשה לפיצויי פרישה — הוצאות השנה', '{"en":"Severance pay charge for the year"}'::jsonb, 'expense', false, null, 630),
  ('IL', 'default', '6120', 'ביטוח בריאות ורפואי לעובדים', '{"en":"Employee health insurance"}'::jsonb, 'expense', false, null, 640),
  ('IL', 'default', '6130', 'הכשרה וגיוס עובדים', '{"en":"Recruitment and training"}'::jsonb, 'expense', false, null, 650),
  ('IL', 'default', '6200', 'שכירות והחזקת משרד', '{"en":"Rent and office occupancy"}'::jsonb, 'expense', false, null, 660),
  ('IL', 'default', '6210', 'חשמל ומים', '{"en":"Electricity and water"}'::jsonb, 'expense', false, null, 670),
  ('IL', 'default', '6220', 'ציוד וחומרים משרדיים', '{"en":"Office supplies and materials"}'::jsonb, 'expense', false, null, 680),
  ('IL', 'default', '6230', 'תקשוב ותוכנה', '{"en":"IT and software"}'::jsonb, 'expense', false, null, 690),
  ('IL', 'default', '6240', 'תיקונים ואחזקה', '{"en":"Repairs and maintenance"}'::jsonb, 'expense', false, null, 700),
  ('IL', 'default', '6300', 'נסיעות', '{"en":"Travel"}'::jsonb, 'expense', false, null, 710),
  ('IL', 'default', '6310', 'אירוח — מע״מ אינו ניתן לניכוי', '{"en":"Entertainment — VAT not recoverable"}'::jsonb, 'expense', false, null, 720),
  ('IL', 'default', '6320', 'הוצאות החזקת רכב', '{"en":"Motor vehicle running costs"}'::jsonb, 'expense', false, null, 730),
  ('IL', 'default', '6400', 'שכר טרחה מקצועי', '{"en":"Professional fees"}'::jsonb, 'expense', false, null, 740),
  ('IL', 'default', '6410', 'עמלות והוצאות בנק', '{"en":"Bank fees and charges"}'::jsonb, 'expense', false, null, 750),
  ('IL', 'default', '6420', 'ביטוח', '{"en":"Insurance"}'::jsonb, 'expense', false, null, 760),
  ('IL', 'default', '6430', 'שיווק ופרסום', '{"en":"Marketing and advertising"}'::jsonb, 'expense', false, null, 770),
  ('IL', 'default', '6440', 'אגרות ותשלומים לרשויות', '{"en":"Licence fees and government charges"}'::jsonb, 'expense', false, null, 780),
  ('IL', 'default', '6500', 'פחת', '{"en":"Depreciation"}'::jsonb, 'expense_depreciation', false, null, 790),
  ('IL', 'default', '6510', 'הפחתת נכסים בלתי מוחשיים', '{"en":"Amortisation of intangible assets"}'::jsonb, 'expense_depreciation', false, null, 800),
  ('IL', 'default', '6950', 'הפסדי שער חליפין — ממומשים', '{"en":"Realised foreign exchange loss"}'::jsonb, 'expense', false, null, 810),
  ('IL', 'default', '6955', 'הפסדי שער חליפין — טרם מומשו', '{"en":"Unrealised foreign exchange loss"}'::jsonb, 'expense', false, null, 820),
  ('IL', 'default', '6990', 'הפרשי עיגול', '{"en":"Rounding differences"}'::jsonb, 'expense', false, null, 830),
  ('IL', 'default', '7100', 'הוצאות מימון', '{"en":"Finance costs"}'::jsonb, 'expense', false, null, 840),
  ('IL', 'default', '8000', 'הוצאות מס חברות לשנה', '{"en":"Income tax expense for the year"}'::jsonb, 'expense', false, null, 850)
...
select v.statement_code, v.line_code, v.sequence, v.rule_kind, v.code_from,
  ...
  from (values
    ('IL-IAS1-IS', 'REV', 10, 'code_range', '4000', '4030', null, 'any'),
    ('IL-IAS1-IS', 'OINC', 10, 'code_range', '4700', '4790', null, 'any'),
    ('IL-IAS1-IS', 'COS', 10, 'code_range', '5000', '5030', null, 'any'),
    ('IL-IAS1-IS', 'EMP', 10, 'code_range', '6100', '6130', null, 'any'),
    ('IL-IAS1-IS', 'DEP', 10, 'code_range', '6500', '6510', null, 'any'),
    ('IL-IAS1-IS', 'OPEX', 10, 'code_range', '6200', '6440', null, 'any'),
    ('IL-IAS1-IS', 'FIN', 10, 'code_range', '6950', '7100', null, 'any'),
    ('IL-IAS1-IS', 'TAX', 10, 'account_code', '8000', null, null, 'any'),
    ('IL-IAS1-SFP', 'CA.1', 10, 'code_range', '1000', '1020', null, 'any'),
    ('IL-IAS1-SFP', 'CA.2', 10, 'code_range', '1100', '1160', null, 'any'),
    ('IL-IAS1-SFP', 'CA.3', 10, 'code_range', '1200', '1230', null, 'any'),
    ('IL-IAS1-SFP', 'CA.4', 10, 'account_code', '1300', null, null, 'any'),
    ('IL-IAS1-SFP', 'NCA.1', 10, 'code_range', '1600', '1641', null, 'any'),
    ('IL-IAS1-SFP', 'NCA.2', 10, 'code_range', '1700', '1710', null, 'any'),
    ('IL-IAS1-SFP', 'NCA.3', 10, 'code_range', '1750', '1751', null, 'any'),
    ('IL-IAS1-SFP', 'CL.1', 10, 'account_code', '2000', null, null, 'any'),
    ('IL-IAS1-SFP', 'CL.2', 10, 'code_range', '2010', '2060', null, 'any'),
    ('IL-IAS1-SFP', 'CL.2', 20, 'account_code', '2990', null, null, 'any'),
    ('IL-IAS1-SFP', 'CL.3', 10, 'code_range', '2100', '2110', null, 'any'),
    ('IL-IAS1-SFP', 'CL.4', 10, 'account_code', '2150', null, null, 'any'),
    ('IL-IAS1-SFP', 'CL.5', 10, 'code_range', '2200', '2210', null, 'any'),
    ('IL-IAS1-SFP', 'NCL.1', 10, 'account_code', '2300', null, null, 'any'),
    ('IL-IAS1-SFP', 'NCL.2', 10, 'account_code', '2350', null, null, 'any'),
    ('IL-IAS1-SFP', 'EQ.1', 10, 'code_range', '3000', '3020', null, 'any'),
