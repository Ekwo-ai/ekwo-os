...
--
-- Generated from packs/ee at version 1.10.0, do not edit.
...
values
  ('EE', 'EE-P-05-AJA', 'Ajakirjandusväljaande soetamine 5%', '{"en":"Acquisition of a press publication 5%"}'::jsonb, 'Ajakirjandusväljaande maksumäär 01.08.2022–31.12.2024', 'percent', 5, 'purchase', 'domestic', date '2022-08-01', date '2024-12-31', 'KMS § 15 lg 2¹, redaktsioon RT I, 04.06.2022, 4, kehtetu alates 01.01.2025, ja § 29 lg 1 — ajakirjandusväljaande soetamisel arvele märgitud 5-protsendiline käibemaks on sisendkäibemaksuna mahaarvatav; vormil KMD lahter 5', 'S', null, 185, 'vat', true, '{}'::tax_condition[], null, false, false, null, 'kms', null, null, null, null),
...
select t.id,
       ...
       v.sequence::integer
  from (values
    ('EE-P-05-AJA', 'invoice', 'tax', 100, '2311', '5', array['5']::text[], 100, 'EE-KMD', 10),
    ('EE-P-05-AJA', 'credit_note', 'tax', 100, '2311', '5', array['5']::text[], -100, 'EE-KMD', 10),
