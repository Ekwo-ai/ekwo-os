...
values
  ...
  ('NZ', 'NZ-P-WT-NONOTIFY', 'Schedular payment to a contractor with no IRD number provided — 45 % withheld', '{}'::jsonb, null, 'percent', 45, 'purchase', 'not_subject', date '2010-04-01', null, 'Income Tax Act 2007, sch. 4 — a schedular payment (a contract payment for an activity the schedule lists: building and construction, cleaning, forestry, agricultural contracting and others) carries withholding tax at the rate the schedule sets for that activity, deducted by the payer under the PAYE rules and paid to the Commissioner; where the contractor has not provided their IRD number, the no-notification rate applies instead of the activity''s own rate, currently 45 %. A community pack: the exact section (the no-notification provision is generally cited as s. RD 10) and the activity-specific rates of Schedule 4 were not confirmed against the operative text of the Income Tax Act 2007 in this session — legislation.govt.nz refused every automated read attempted, scripted and browser-driven alike — only against general knowledge of the schedular payment withholding regime; a reviewer should read Schedule 4 and the no-notification provision before relying on the 45 % figure or the section number. This tax is not a GST mechanism and is not reported on the GST101A; it is declared beside the GST codes only because it is a genuine New Zealand withholding tax a purchase invoice can carry, the way AU-P-NOABN-47 sits beside the Australian GST codes for the same reason.', null, null, 180, 'withholding', true, '{}'::tax_condition[], null, false, false, null, 'income-tax-act', null, null, null, null),
...
select t.id,
  ...
  from (values
    ...
    ('NZ-P-WT-NONOTIFY', 'invoice', 'base', 100, null, null, null, 100, null, 10),
    ('NZ-P-WT-NONOTIFY', 'invoice', 'tax', -100, '2085', null, null, 100, null, 20),
    ('NZ-P-WT-NONOTIFY', 'credit_note', 'base', 100, null, null, null, 100, null, 10),
    ('NZ-P-WT-NONOTIFY', 'credit_note', 'tax', -100, '2085', null, null, 100, null, 20),
