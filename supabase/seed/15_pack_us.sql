...
--
-- Generated from packs/us at version 0.8.0, do not edit.
...
--   Revenue and Taxation Code, section 6901, Credits and refunds — the Sales and Use Tax Law as the Business Taxes Law Guide, revision 2026, prints it (California Department of Tax and Fee Administration — Business Taxes Law Guide)
--     https://www.cdtfa.ca.gov/lawguides/vol1/sutl/6901.html
...
values
  ...
  ('US', 'default', '1185', 'Sales and use tax overpaid — credit or refund due on a filed return', '{}'::jsonb, 'asset_current', true, null, 205),
  ...
  ('US', 'default', '2208', 'Sales and use tax due on filed returns — the net each return carries to the administration', '{}'::jsonb, 'liability_current', true, null, 1025),
...
insert into country_defaults
  (country, name, name_i18n, languages, currency_code, receivable_code, payable_code, suspense_code,
   ...
   vat_period_default)
values
  ('US', 'United States', '{}'::jsonb, array['en']::text[], 'USD', '1100', '2000', '2390', '6990', '3400', '4000', '5000', '1000', '1010', 'SAL', 'PUR', 'GEN', 'en', 'retained_earnings', null, null, null, 'OPN', 'half_up', default, '7010', '7210', '7020', '7200', null, null, '2208', '1185', null, 'quarter'::declaration_period)
on conflict (country) do update set
  name                   = excluded.name,
  name_i18n              = excluded.name_i18n,
