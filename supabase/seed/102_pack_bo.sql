...
values
  ('BO', 'BO-SIN-200', 'BASE13', 'base', 'Ventas gravadas en el mercado interno, netas del impuesto (uso interno del paquete)', '{"en":"Domestic taxable sales, net of tax (this pack''s own bookkeeping box)"}'::jsonb, 5, null, '{}'::text[], '{}'::text[], null, null, false, true, null, 'No es una casilla del Formulario 200: es el importe neto del impuesto que el motor separa de un precio facturado con el impuesto ya incluido (art. 5° de la Ley N.° 843). La casilla 13 del formulario, que pide el importe total facturado, se reconstruye como el total de esta casilla más el débito fiscal de la casilla 39 — véase «El IVA se calcula por dentro» en el README', 'ley-843'),
  ...
  ('BO', 'BO-SIN-200', 'BASE26', 'base', 'Compras vinculadas a actividades gravadas, netas del impuesto (uso interno del paquete)', '{"en":"Purchases linked to taxable activities, net of tax (this pack''s own bookkeeping box)"}'::jsonb, 55, null, '{}'::text[], '{}'::text[], null, null, false, true, null, 'No es una casilla del Formulario 200: es el importe neto del impuesto que el motor separa de un precio facturado por el proveedor con el impuesto ya incluido. La casilla 26 del formulario, que pide el importe total de la compra, se reconstruye como el total de esta casilla más el crédito fiscal de la casilla 114', 'ley-843'),
