...
select t.id,
  ...
  from (values
    ...
    ('VN-P-10', 'invoice', 'tax', 100, '1331', '24', array['24']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-10', 'credit_note', 'base', 100, null, '23', array['23']::text[], -100, 'VN-VAT-01-GTGT', 10),
    ('VN-P-10', 'credit_note', 'tax', 100, '1331', '24', array['24']::text[], -100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-5', 'invoice', 'base', 100, null, '23', array['23']::text[], 100, 'VN-VAT-01-GTGT', 10),
    ('VN-P-5', 'invoice', 'tax', 100, '1331', '24', array['24']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-5', 'credit_note', 'base', 100, null, '23', array['23']::text[], -100, 'VN-VAT-01-GTGT', 10),
    ('VN-P-5', 'credit_note', 'tax', 100, '1331', '24', array['24']::text[], -100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-8-NQ204', 'invoice', 'base', 100, null, '23', array['23']::text[], 100, 'VN-VAT-01-GTGT', 10),
    ('VN-P-8-NQ204', 'invoice', 'tax', 100, '1331', '24', array['24']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-8-NQ204', 'credit_note', 'base', 100, null, '23', array['23']::text[], -100, 'VN-VAT-01-GTGT', 10),
    ('VN-P-8-NQ204', 'credit_note', 'tax', 100, '1331', '24', array['24']::text[], -100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-IMP-10', 'invoice', 'base', 100, null, null, null, 100, null, 10),
    ('VN-P-IMP-10', 'invoice', 'tax', 100, '1331', '24', array['24']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-P-IMP-10', 'invoice', 'tax', -100, '33312', null, null, 100, null, 30),
    ('VN-P-IMP-10', 'credit_note', 'base', 100, null, null, null, 100, null, 10),
    ('VN-P-IMP-10', 'credit_note', 'tax', 100, '1331', '24', array['24']::text[], -100, 'VN-VAT-01-GTGT', 20),
    ...
    ('VN-S-10', 'invoice', 'tax', 100, '33311', '32', array['32']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-S-10', 'credit_note', 'base', 100, null, '31', array['31']::text[], -100, 'VN-VAT-01-GTGT', 10),
    ('VN-S-10', 'credit_note', 'tax', 100, '33311', '32', array['32']::text[], -100, 'VN-VAT-01-GTGT', 20),
    ('VN-S-5', 'invoice', 'base', 100, null, '29', array['29']::text[], 100, 'VN-VAT-01-GTGT', 10),
    ('VN-S-5', 'invoice', 'tax', 100, '33311', '30', array['30']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-S-5', 'credit_note', 'base', 100, null, '29', array['29']::text[], -100, 'VN-VAT-01-GTGT', 10),
    ('VN-S-5', 'credit_note', 'tax', 100, '33311', '30', array['30']::text[], -100, 'VN-VAT-01-GTGT', 20),
    ('VN-S-8-NQ204', 'invoice', 'base', 100, null, '31', array['31']::text[], 100, 'VN-VAT-01-GTGT', 10),
    ('VN-S-8-NQ204', 'invoice', 'tax', 100, '33311', '32', array['32']::text[], 100, 'VN-VAT-01-GTGT', 20),
    ('VN-S-8-NQ204', 'credit_note', 'base', 100, null, '31', array['31']::text[], -100, 'VN-VAT-01-GTGT', 10),
    ('VN-S-8-NQ204', 'credit_note', 'tax', 100, '33311', '32', array['32']::text[], -100, 'VN-VAT-01-GTGT', 20),
