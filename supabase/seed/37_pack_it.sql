...
values
  ...
  ('IT', 'default', '1110', 'Erario c/IVA a credito', '{"en":"Deductible VAT"}'::jsonb, 'asset_current', true, null, 420),
  ('IT', 'default', '1111', 'Erario c/IVA a credito da riportare', '{"en":"VAT credit carried forward"}'::jsonb, 'asset_current', true, null, 425),
  ...
  ('IT', 'default', '2200', 'Erario c/IVA a debito', '{"en":"Output VAT"}'::jsonb, 'liability_current', true, null, 600),
  ('IT', 'default', '2201', 'Erario c/IVA da versare', '{"en":"VAT payable"}'::jsonb, 'liability_current', true, null, 605),
...
insert into country_defaults
  (country, name, name_i18n, languages, currency_code, receivable_code, payable_code, suspense_code,
   ...
   vat_period_default)
values
  ('IT', 'Italia', '{"en":"Italy"}'::jsonb, array['it', 'en']::text[], 'EUR', '1100', '2100', '2900', '5460', '3100', '4000', '5000', '1300', '1310', 'VEN', 'ACQ', 'VAR', 'it', 'result_accounts', '3200', '3200', null, 'APE', 'half_up', default, '4340', '8010', null, null, null, null, '2201', '1111', 'Scrittura di apertura', 'year'::declaration_period)
on conflict (country) do update set
  name                   = excluded.name,
  name_i18n              = excluded.name_i18n,
