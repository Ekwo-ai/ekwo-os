...
insert into country_defaults
  (country, name, name_i18n, languages, currency_code, receivable_code, payable_code, suspense_code,
   ...
   vat_period_default)
values
  ('AT', 'Austria', '{"en":"Austria"}'::jsonb, array['de', 'en']::text[], 'EUR', '2200', '6400', '2239', '8818', '4400', '8100', '8500', '2410', '2400', 'VK', 'EK', 'SO', 'de', 'retained_earnings', null, null, null, 'EB', 'half_up', default, '8430', '8808', null, null, null, null, '6810', '2237', null, 'month'::declaration_period)
on conflict (country) do update set
  name                   = excluded.name,
  name_i18n              = excluded.name_i18n,
