...
insert into country_defaults
  (country, name, name_i18n, languages, currency_code, receivable_code, payable_code, suspense_code,
   ...
   vat_period_default)
values
  ('CH', 'Schweiz', '{"fr":"Suisse"}'::jsonb, array['de', 'fr']::text[], 'CHF', '1100', '2000', '2300', '8950', '2900', '3000', '4000', '1020', '1000', 'SAL', 'PUR', 'GEN', 'de', 'retained_earnings', null, null, null, 'OPN', 'half_up', default, null, null, null, null, null, null, '2140', '1176', null, null)
on conflict (country) do update set
  name                   = excluded.name,
  name_i18n              = excluded.name_i18n,
