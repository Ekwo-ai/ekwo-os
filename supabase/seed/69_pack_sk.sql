...
select t.id,
       ...
       v.sequence::integer
  from (values
    ('SK-P-19', 'invoice', 'tax', 100, '343', '18', array['18']::text[], 100, 'SK-DPH', 10),
    ('SK-P-19', 'credit_note', 'tax', 100, '343', '18', array['18']::text[], -100, 'SK-DPH', 10),
    ('SK-P-23', 'invoice', 'tax', 100, '343', '19', array['19']::text[], 100, 'SK-DPH', 10),
    ('SK-P-23', 'credit_note', 'tax', 100, '343', '19', array['19']::text[], -100, 'SK-DPH', 10),
    ('SK-P-5', 'invoice', 'tax', 100, '343', '18a', array['18a']::text[], 100, 'SK-DPH', 10),
    ('SK-P-5', 'credit_note', 'tax', 100, '343', '18a', array['18a']::text[], -100, 'SK-DPH', 10),
    ('SK-P-DOVOZ-23', 'invoice', 'base', 100, null, null, null, 100, null, 10),
    ('SK-P-DOVOZ-23', 'invoice', 'tax', 100, '343', '23', array['23']::text[], 100, 'SK-DPH', 20),
    ('SK-P-DOVOZ-23', 'credit_note', 'base', 100, null, null, null, -100, null, 10),
    ('SK-P-DOVOZ-23', 'credit_note', 'tax', 100, '343', '23', array['23']::text[], -100, 'SK-DPH', 20),
    ('SK-P-IC-23', 'invoice', 'base', 100, null, '07', array['07']::text[], 100, 'SK-DPH', 10),
    ('SK-P-IC-23', 'invoice', 'tax', 100, '343', '19', array['19']::text[], 100, 'SK-DPH', 20),
    ('SK-P-IC-23', 'invoice', 'tax', -100, '343', '08', array['08']::text[], 100, 'SK-DPH', 30),
    ('SK-P-IC-23', 'credit_note', 'base', 100, null, '07', array['07']::text[], -100, 'SK-DPH', 10),
    ('SK-P-IC-23', 'credit_note', 'tax', 100, '343', '19', array['19']::text[], -100, 'SK-DPH', 20),
    ('SK-P-IC-23', 'credit_note', 'tax', -100, '343', '08', array['08']::text[], -100, 'SK-DPH', 30),
    ...
    ('SK-P-RC-STAVBY-23', 'invoice', 'tax', 100, '343', '19', array['19']::text[], 100, 'SK-DPH', 20),
    ('SK-P-RC-STAVBY-23', 'invoice', 'tax', -100, '343', '10b', array['10b']::text[], 100, 'SK-DPH', 30),
    ('SK-P-RC-STAVBY-23', 'credit_note', 'base', 100, null, '09b', array['09b']::text[], -100, 'SK-DPH', 10),
    ('SK-P-RC-STAVBY-23', 'credit_note', 'tax', 100, '343', '19', array['19']::text[], -100, 'SK-DPH', 20),
    ('SK-P-RC-STAVBY-23', 'credit_note', 'tax', -100, '343', '10b', array['10b']::text[], -100, 'SK-DPH', 30),
    ('SK-P-SLUZBA-EU-23', 'invoice', 'base', 100, null, '09b', array['09b']::text[], 100, 'SK-DPH', 10),
    ('SK-P-SLUZBA-EU-23', 'invoice', 'tax', 100, '343', '19', array['19']::text[], 100, 'SK-DPH', 20),
    ('SK-P-SLUZBA-EU-23', 'invoice', 'tax', -100, '343', '10b', array['10b']::text[], 100, 'SK-DPH', 30),
    ('SK-P-SLUZBA-EU-23', 'credit_note', 'base', 100, null, '09b', array['09b']::text[], -100, 'SK-DPH', 10),
    ('SK-P-SLUZBA-EU-23', 'credit_note', 'tax', 100, '343', '19', array['19']::text[], -100, 'SK-DPH', 20),
    ('SK-P-SLUZBA-EU-23', 'credit_note', 'tax', -100, '343', '10b', array['10b']::text[], -100, 'SK-DPH', 30),
    ('SK-P-SLUZBA-MIMO-EU-23', 'invoice', 'base', 100, null, '09b', array['09b']::text[], 100, 'SK-DPH', 10),
    ('SK-P-SLUZBA-MIMO-EU-23', 'invoice', 'tax', 100, '343', '19', array['19']::text[], 100, 'SK-DPH', 20),
    ('SK-P-SLUZBA-MIMO-EU-23', 'invoice', 'tax', -100, '343', '10b', array['10b']::text[], 100, 'SK-DPH', 30),
    ('SK-P-SLUZBA-MIMO-EU-23', 'credit_note', 'base', 100, null, '09b', array['09b']::text[], -100, 'SK-DPH', 10),
    ('SK-P-SLUZBA-MIMO-EU-23', 'credit_note', 'tax', 100, '343', '19', array['19']::text[], -100, 'SK-DPH', 20),
    ('SK-P-SLUZBA-MIMO-EU-23', 'credit_note', 'tax', -100, '343', '10b', array['10b']::text[], -100, 'SK-DPH', 30),
    ('SK-S-19', 'invoice', 'base', 100, null, '01', array['01']::text[], 100, 'SK-DPH', 10),
    ('SK-S-19', 'invoice', 'tax', 100, '343', '02', array['02']::text[], 100, 'SK-DPH', 20),
    ('SK-S-19', 'credit_note', 'base', 100, null, '01', array['01']::text[], -100, 'SK-DPH', 10),
    ('SK-S-19', 'credit_note', 'tax', 100, '343', '02', array['02']::text[], -100, 'SK-DPH', 20),
    ('SK-S-23', 'invoice', 'base', 100, null, '03', array['03']::text[], 100, 'SK-DPH', 10),
    ('SK-S-23', 'invoice', 'tax', 100, '343', '04', array['04']::text[], 100, 'SK-DPH', 20),
    ('SK-S-23', 'credit_note', 'base', 100, null, '03', array['03']::text[], -100, 'SK-DPH', 10),
    ('SK-S-23', 'credit_note', 'tax', 100, '343', '04', array['04']::text[], -100, 'SK-DPH', 20),
    ('SK-S-5', 'invoice', 'base', 100, null, '01a', array['01a']::text[], 100, 'SK-DPH', 10),
    ('SK-S-5', 'invoice', 'tax', 100, '343', '02a', array['02a']::text[], 100, 'SK-DPH', 20),
    ('SK-S-5', 'credit_note', 'base', 100, null, '01a', array['01a']::text[], -100, 'SK-DPH', 10),
    ('SK-S-5', 'credit_note', 'tax', 100, '343', '02a', array['02a']::text[], -100, 'SK-DPH', 20),
