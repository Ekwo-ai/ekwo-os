...
insert into statement_templates
  (code, country, chart_code, name, kind, framework, valid_from, valid_to, legal_reference,
   source_key)
values
  ('GR-ELP-BS', 'GR', 'default', 'Ισολογισμός', 'balance_sheet', 'GR-ELP', date '1970-01-01', null, 'Ν.4308/2014 (ΕΛΠ), άρθρο 16 παρ. 7 και Παράρτημα Β, Υπόδειγμα Β.5 — συνοπτικός Ισολογισμός πολύ μικρών οντοτήτων της παρ. 2(α) του άρθρου 1. Η ίδια η παρ. 7 του άρθρου 16 επιτρέπει ρητά σε πολύ μικρές οντότητες να καταρτίζουν τη συνοπτική αυτή μορφή αντί του πλήρους υποδείγματος Β.1. Οι λεζάντες ακολουθούν τη σειρά και τη διατύπωση του υποδείγματος όπως καταρτίζεται στην πράξη· η αντιστοίχιση λογαριασμός-προς-γραμμή είναι επιλογή αυτού του πακέτου πάνω στην αρίθμηση ΕΓΛΣ του accounts.csv και χρειάζεται έλεγχο από λογιστή πριν από παραγωγική χρήση — βλ. README', 'n4308-2014'),
  ('GR-ELP-IS', 'GR', 'default', 'Κατάσταση Αποτελεσμάτων', 'income_statement', 'GR-ELP', date '1970-01-01', null, 'Ν.4308/2014 (ΕΛΠ), άρθρο 16 παρ. 7 και Παράρτημα Β, Υπόδειγμα Β.6 — συνοπτική Κατάσταση Αποτελεσμάτων πολύ μικρών οντοτήτων. Δύο γραμμές του υποδείγματος δεν εμφανίζονται εδώ — ''Μεταβολές αποθεμάτων'' και ''Αγορές εμπορευμάτων και υλικών'' — γιατί accounts.csv δεν διαχωρίζει ακόμη κόστος πωληθέντων από απόθεμα τέλους χρήσεως (ο λογαριασμός 2002 διαβάζεται εξ ολοκλήρου ως απόθεμα στον Ισολογισμό, βλ. GR-ELP-BS:AC-INV): μια γραμμή που κανένας λογαριασμός δεν φτάνει δεν εξυπηρετεί κανέναν. Για τον ίδιο λόγο η κατάσταση σταματά στο ''Αποτέλεσμα προ φόρων'': accounts.csv δεν φέρει ακόμη λογαριασμό εξόδου φόρου εισοδήματος/τέλους επιτηδεύματος (μόνο τον παρακρατηθέντα/προκαταβλητέο φόρο ως υποχρέωση, λογαριασμός 5403) — το αποτέλεσμα μετά φόρων χρειάζεται τον υπολογισμό ενός λογιστή, δεν προσεγγίζεται εδώ', 'n4308-2014')
...
values
  ('GR-ELP-BS', 'ANC', 'TOT-ATT', 'Μη κυκλοφορούντα περιουσιακά στοιχεία', '{"en":"Non-current assets"}'::jsonb, 10, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ ομάδα 1 (πάγια, έξοδα εγκατάστασης) και οι μακροπρόθεσμες συμμετοχές/απαιτήσεις των υποομάδων 17-18 και 32', null),
  ('GR-ELP-BS', 'AC-INV', 'AC', 'Αποθέματα', '{"en":"Inventories"}'::jsonb, 20, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ ομάδα 2 — αποθέματα και αγορές χρήσεως εμπορευμάτων, πρώτων υλών και αναλωσίμων', null),
  ('GR-ELP-BS', 'AC-REC', 'AC', 'Απαιτήσεις', '{"en":"Receivables"}'::jsonb, 30, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ υποομάδες 30-31 (πελάτες, γραμμάτια εισπρακτέα) και 33 (χρεώστες διάφοροι, ΦΠΑ προς επιστροφή, προκαταβολές σε προμηθευτές, απαιτήσεις κατά συνδεδεμένων)', null),
  ('GR-ELP-BS', 'AC-PREP', 'AC', 'Προκαταβολές και έσοδα εισπρακτέα', '{"en":"Prepayments and accrued income"}'::jsonb, 40, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 36 — έξοδα επόμενων χρήσεων, έξοδα υπό τακτοποίηση, έσοδα χρήσεως εισπρακτέα', null),
  ('GR-ELP-BS', 'AC-OTH', 'AC', 'Λοιπά', '{"en":"Other"}'::jsonb, 50, 1, false, '{}'::text[], '{}'::text[], null, 'Χρεόγραφα (ΕΓΛΣ 34) και ο εκπιπτόμενος ΦΠΑ εισροών (5401), που παρότι φέρει κωδικό της ομάδας 5 έχει χρεωστικό υπόλοιπο απαίτησης', null),
  ('GR-ELP-BS', 'AC-CASH', 'AC', 'Ταμειακά διαθέσιμα και ισοδύναμα', '{"en":"Cash and cash equivalents"}'::jsonb, 60, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 38 — ταμείο και καταθέσεις όψεως/προθεσμίας', null),
  ('GR-ELP-BS', 'AC', 'TOT-ATT', 'Σύνολο κυκλοφορούντων στοιχείων', '{"en":"Total current assets"}'::jsonb, 70, 1, true, array['AC-INV', 'AC-REC', 'AC-PREP', 'AC-OTH', 'AC-CASH']::text[], '{}'::text[], null, null, null),
  ('GR-ELP-BS', 'TOT-ATT', null, 'Σύνολο ενεργητικού', '{"en":"Total assets"}'::jsonb, 80, 1, true, array['ANC', 'AC']::text[], '{}'::text[], null, null, null),
  ('GR-ELP-BS', 'CAP', 'EQ-TOT', 'Κεφάλαια και αποθεματικά', '{"en":"Capital and reserves"}'::jsonb, 90, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ υποομάδα 40-42 (κεφάλαιο, αποθεματικά, αποτελέσματα εις νέο) και ομάδα 8 (αποτελεσματικοί λογαριασμοί, μεταξύ των οποίων ο λογαριασμός 86 όπου κλείνει το αποτέλεσμα χρήσεως προς διάθεση)', null),
  ('GR-ELP-BS', 'EQ-TOT', 'TOT-PATH', 'Σύνολο καθαρής θέσης', '{"en":"Total equity"}'::jsonb, 100, 1, true, array['CAP']::text[], '{}'::text[], null, null, null),
  ('GR-ELP-BS', 'L-NC', 'L-TOT', 'Μακροπρόθεσμες υποχρεώσεις', '{"en":"Non-current liabilities"}'::jsonb, 110, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ υποομάδες 44-47 — επιχορηγήσεις παγίων, προβλέψεις και μακροπρόθεσμα δάνεια', null),
  ('GR-ELP-BS', 'L-C', 'L-TOT', 'Βραχυπρόθεσμες υποχρεώσεις', '{"en":"Current liabilities"}'::jsonb, 120, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ ομάδα 5, εκτός του λογαριασμού 5401 (βλ. AC-OTH) — προμηθευτές, τράπεζες, ΦΠΑ εκκαθάρισης, ασφαλιστικοί οργανισμοί και λοιποί πιστωτές', null),
  ('GR-ELP-BS', 'L-TOT', 'TOT-PATH', 'Σύνολο Υποχρεώσεων', '{"en":"Total liabilities"}'::jsonb, 130, 1, true, array['L-NC', 'L-C']::text[], '{}'::text[], null, null, null),
  ('GR-ELP-BS', 'TOT-PATH', null, 'Σύνολο Παθητικού', '{"en":"Total equity and liabilities"}'::jsonb, 140, 1, true, array['EQ-TOT', 'L-TOT']::text[], '{}'::text[], null, null, null),
  ('GR-ELP-IS', 'REV', 'RESULT', 'Κύκλος εργασιών (καθαρός)', '{"en":"Net turnover"}'::jsonb, 10, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ υποομάδες 70-73 — πωλήσεις εμπορευμάτων, προϊόντων και υπηρεσιών, εσωτερικού, ενδοκοινοτικών και τρίτων χωρών', null),
  ('GR-ELP-IS', 'OTH-INC', 'RESULT', 'Λοιπά συνήθη έσοδα', '{"en":"Other usual income"}'::jsonb, 20, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 74 — επιχορηγήσεις και λοιπά έσοδα πωλήσεων', null),
  ('GR-ELP-IS', 'STAFF', 'RESULT', 'Παροχές σε εργαζόμενους', '{"en":"Employee benefits expense"}'::jsonb, 30, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 60 — αμοιβές και εργοδοτικές εισφορές έμμισθου και ημερομίσθιου προσωπικού', null),
  ('GR-ELP-IS', 'DEPR', 'RESULT', 'Αποσβέσεις ενσώματων παγίων και άύλων στοιχείων', '{"en":"Depreciation of tangible and intangible assets"}'::jsonb, 40, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 66 — αποσβέσεις ενσώματων και άυλων παγίων', null),
  ('GR-ELP-IS', 'OTH-EXP', 'RESULT', 'Λοιπά έξοδα και ζημίες', '{"en":"Other expenses and losses"}'::jsonb, 50, 1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμοί 61, 62, 63 (πλην αμοιβών προσωπικού), 68 — αμοιβές τρίτων, παροχές τρίτων, φόροι-τέλη πλην φόρου εισοδήματος και προβλέψεις εκμεταλλεύσεως', null),
  ('GR-ELP-IS', 'OTH-GAIN', 'RESULT', 'Λοιπά έσοδα και κέρδη', '{"en":"Other income and gains"}'::jsonb, 60, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 78 — έκτακτα και ανόργανα έσοδα, έσοδα προηγούμενων χρήσεων', null),
  ('GR-ELP-IS', 'FIN', 'RESULT', 'Τόκοι και συναφή κονδύλια (καθαρό ποσό)', '{"en":"Interest and related items (net)"}'::jsonb, 70, -1, false, '{}'::text[], '{}'::text[], null, 'ΕΓΛΣ λογαριασμός 65 (τόκοι και έξοδα τραπεζών) καθαρά έναντι του λογαριασμού 76 (έσοδα συμμετοχών, χρεογράφων και πιστωτικοί τόκοι) — μία καθαρή γραμμή, όπως στο υπόδειγμα Β.6', null),
  ('GR-ELP-IS', 'RESULT', null, 'Αποτέλεσμα προ φόρων', '{"en":"Result before tax"}'::jsonb, 80, 1, true, array['REV', 'OTH-INC', 'OTH-GAIN', 'FIN']::text[], array['STAFF', 'DEPR', 'OTH-EXP']::text[], null, null, null)
...
select v.statement_code, v.line_code, v.sequence, v.rule_kind, v.code_from,
  ...
  from (values
    ('GR-ELP-BS', 'ANC', 10, 'code_range', '1000', '1999', null, 'any'),
    ('GR-ELP-BS', 'ANC', 20, 'account_code', '3200', null, null, 'any'),
    ('GR-ELP-BS', 'AC-INV', 10, 'code_range', '2000', '2899', null, 'any'),
    ('GR-ELP-BS', 'AC-REC', 10, 'code_range', '3000', '3110', null, 'any'),
    ('GR-ELP-BS', 'AC-REC', 20, 'code_range', '3300', '3329', null, 'any'),
    ('GR-ELP-BS', 'AC-PREP', 10, 'code_range', '3600', '3629', null, 'any'),
    ('GR-ELP-BS', 'AC-OTH', 10, 'code_range', '3400', '3410', null, 'any'),
    ('GR-ELP-BS', 'AC-OTH', 20, 'account_code', '5401', null, null, 'any'),
    ('GR-ELP-BS', 'AC-CASH', 10, 'code_range', '3800', '3805', null, 'any'),
    ('GR-ELP-BS', 'CAP', 10, 'code_range', '4000', '4299', null, 'any'),
    ('GR-ELP-BS', 'CAP', 20, 'code_range', '8000', '8600', null, 'any'),
    ('GR-ELP-BS', 'L-NC', 10, 'code_range', '4300', '4799', null, 'any'),
    ('GR-ELP-BS', 'L-C', 10, 'code_range', '5000', '5400', null, 'any'),
    ('GR-ELP-BS', 'L-C', 20, 'code_range', '5402', '5899', null, 'any'),
    ('GR-ELP-IS', 'REV', 10, 'code_range', '7000', '7302', null, 'any'),
    ('GR-ELP-IS', 'OTH-INC', 10, 'code_range', '7400', '7410', null, 'any'),
    ('GR-ELP-IS', 'STAFF', 10, 'code_range', '6000', '6099', null, 'any'),
    ('GR-ELP-IS', 'DEPR', 10, 'code_range', '6600', '6699', null, 'any'),
    ('GR-ELP-IS', 'OTH-EXP', 10, 'code_range', '6100', '6430', null, 'any'),
    ('GR-ELP-IS', 'OTH-EXP', 20, 'code_range', '6800', '6899', null, 'any'),
    ('GR-ELP-IS', 'OTH-GAIN', 10, 'code_range', '7800', '7810', null, 'any'),
    ('GR-ELP-IS', 'FIN', 10, 'account_code', '6500', null, null, 'any'),
    ('GR-ELP-IS', 'FIN', 20, 'code_range', '7600', '7620', null, 'any')
