# Ekwo Contributor Licence Agreement
...
**"Contribution"** means any original work of authorship — code, migrations,
documentation, seed data, tests — that you intentionally submit to Ekwo for
inclusion in the project, by pull request, patch, issue attachment or any
other means.

## 2. Copyright licence

You grant Ekwo, and to recipients of software distributed by Ekwo, a
perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable
copyright licence to reproduce, prepare derivative works of, publicly display,
publicly perform, sublicense and distribute your contributions and such
derivative works.

**This includes the right to distribute your contribution under a different
licence, including a proprietary one.** That is the point of this agreement:
it lets Ekwo relicense the whole project if it ever has to, without hunting
...
otherwise transfer the work, covering only those patent claims licensable by
you that are necessarily infringed by your contribution alone or by its
combination with the project.

If any entity brings patent litigation alleging that the project or a
contribution within it constitutes patent infringement, any patent licence
granted under this agreement to that entity terminates as of the date such
litigation is filed.

## 4. You keep your rights

You retain all right, title and interest in your contributions. Nothing here
restricts your ability to use, licence or distribute your own work elsewhere,
...
- if your employer has rights to work you create, you have permission to make
  the contribution on their behalf, or your employer has waived those rights;
- your contributions do not knowingly infringe anyone's rights, and you will
  tell Ekwo if you become aware that they do;
- you will identify any third-party licence or restriction attached to any
