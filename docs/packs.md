...
a shape, CSV for the chart, which is flat, long, and what accounting
software exchanges — a reviewer reads one line per account in a diff, and
...
| [`cl`](../packs/cl/) | Chile | `46_pack_cl.sql` | es | `community` |
...
| [`ge`](../packs/ge/) | საქართველო | `110_pack_ge.sql` | ka, en | `community` |
| [`gh`](../packs/gh/) | Ghana | `119_pack_gh.sql` | en | `community` |
| [`gn`](../packs/gn/) | Guinée | `29_pack_gn.sql` | fr | `community` |
| [`gq`](../packs/gq/) | Guinée équatoriale | `31_pack_gq.sql` | fr | `community` |
| [`gr`](../packs/gr/) | Ελλάδα | `76_pack_gr.sql` | el, en | `community` |
| [`gt`](../packs/gt/) | Guatemala | `106_pack_gt.sql` | es | `community` |
...
| [`il`](../packs/il/) | Israel | `87_pack_il.sql` | he, en | `community` |
...
| [`om`](../packs/om/) | Oman | `118_pack_om.sql` | ar, en | `community` |
...
| [`ug`](../packs/ug/) | Uganda | `121_pack_ug.sql` | en | `community` |
